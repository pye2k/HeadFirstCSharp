    ...
    public partial class Form1 : Form
    {
        ...
        private void listBox1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (listBox1.Items.Contains(e.KeyCode))
            {
                ...
                // by calling its Update() method with the arguement true
                stats.Update(true);
            }
            else
            {
                // The user pressed an incorrect key, so update the Stats ojbect
                // by calling its Updated() method with the arguement false
                stats.Update(false);
            }
